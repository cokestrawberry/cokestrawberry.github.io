...
**실습 과정**
  1. Low
    ...
    <img src="/assets/230601/230601_screenshot_1.png" width="100%" height="100%" alt="Screenshot_of_source_code(low)"><br/><br/>
    <img src="/assets/230601/230601_screenshot_2.png" width="100%" height="100%" alt="Screenshot_of_return:127.0.0.1"><br/><br/>
    ...
    <img src="/assets/230601/230601_screenshot_3.png" width="100%" height="100%" alt="Screenshot_of_return:127.0.0.1;cat /etc/passwd"><br/><br/>
    ...
    <img src="/assets/230601/230601_screenshot_3-1.png" width="100%" height="100%" alt="Screenshot_of_return:whoami"><br/><br/>

  2. Medium
      * 다음은 Medium 단계 command injection의 공격을 수행할 서비스의 소스코드이다.<br/><br/>
    <img src="/assets/230601/230601_screenshot_4.png" width="100%" height="100%" alt="Screenshot_of_source_code(medium)"><br/><br/>
     ...
     <img src="/assets/230601/230601_screenshot_5.png" width="100%" height="100%" alt="Screenshot_of_return:127.0.0.1 &#124; cat /etc/passwd"><br/><br/>

  3. High
      * 다음은 High 단계 command injection의 공격을 수행할 서비스의 소스코드이다.<br/><br/>
    <img src="/assets/230601/230601_screenshot_6.png" width="100%" height="100%" alt="Screenshot_of_source_code(high)"><br/><br/>
    ...
    <img src="/assets/230601/230601_screenshot_7.png" width="100%" height="100%" alt="Screenshot_of_return:127.0.0.1 &#124;&#124; cat /etc/passwd"><br/><br/>
...
### 결론
  ...
  2. **예상 대응 방안**
    ...
    <img src="/assets/230601/230601_screenshot_8.png" width="100%" height="100%" alt="Screenshot_of_source_code(impossible)"><br/><br/>
